...
gdf_river = gpd.read_file('data3/LSMD_CONT_UJ201_11_202311.shp')

one = pd.read_csv("data3/서울172022-1.csv", encoding='euc-kr')
onee = pd.read_csv("data3/서울172022-2.csv", encoding='euc-kr')
oneee = pd.read_csv("data3/서울172022-3.csv", encoding='euc-kr')

two = pd.read_csv("data3/서울1819-1.csv", encoding='euc-kr')
twoo = pd.read_csv("data3/서울1819-2.csv", encoding='euc-kr')
twooo = pd.read_csv("data3/서울1819-3.csv", encoding='euc-kr')

three = pd.read_csv("data3/서울22-1.csv", encoding='euc-kr')
threee = pd.read_csv("data3/서울22-2.csv", encoding='euc-kr')
...
df_building = gpd.read_file('data3/최최종point.shp')
gdf_seoul_emd = gpd.read_file('data3/서울시경계.shp')
...
def update_choropleth_map(selected_year):
    ...
    count1 = gpd.read_file('data3/영등포구없.shp')
    count2 = gpd.read_file('data3/최종카운트.shp')
